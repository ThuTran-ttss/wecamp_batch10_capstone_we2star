import {Bus, Hotel, Utensils, MapPin, ShoppingBag, Ticket, 
    CircleDot, MoreVertical, AlertTriangle} from "lucide-react"
  ...
  return (
    ...
    >
      ...
      <div className="relative flex justify-end">
        ...
        {isMenuOpen && (
        <div className="absolute right-0 top-9 z-10 w-28 rounded-xl border border-slate-200 bg-white py-2 shadow-lg">
        <button
            type="button"
